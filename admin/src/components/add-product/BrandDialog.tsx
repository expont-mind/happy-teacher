...
export const BrandDialog = ({
  ...
  return (
    <Dialog open={!!creatingBrand} onOpenChange={() => setCreatingBrand(false)}>
      <DialogContent className="bg-white flex flex-col gap-4 rounded-lg shadow-[0px_1px_2px_0px_rgba(0,0,0,0.08)] border border-[#E4E4E7] p-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            <p className="text-gray-500 text-sm font-normal">Brand name</p>
            <input
              value={name}
        ...
        <DialogFooter className="flex justify-end gap-1">
          ...
          <button
            onClick={editingBrand ? handleEditBrand : handleCreateBrand}
