    ...
    <div className="w-full h-full min-h-[calc(100vh-77px)] flex justify-center bg-[#FFFAF7] px-4 pb-10">
      <div className="max-w-[1280px] w-full flex flex-col gap-8 md:gap-14">
        ...
        <div className="flex flex-col gap-7 py-6">
          <h1 className="text-black font-bold text-[32px] font-nunito">
            Хичээлүүд
          </h1>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col gap-2">
                        <h2 className="text-white font-extrabold font-nunito text-xl md:text-2xl tracking-tight">
                          {topic.title}
                        </h2>
                    ...
                    <div className="pt-6 border-t border-white/80 flex items-center justify-between">
                      <p className="text-white font-bold font-nunito text-lg md:text-xl leading-6 max-w-[90%]">
                        {topic.description}
                      </p>
