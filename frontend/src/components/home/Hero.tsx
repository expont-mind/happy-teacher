  ...
  return (
    <div className="w-full flex justify-center bg-white py-16 lg:py-[144px] px-4 overflow-hidden">
      <div className="relative max-w-[1280px] w-full flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
        <h1 className="text-[#1F2937] font-extrabold text-4xl lg:text-[56px] font-nunito max-w-[410px] lg:leading-14 leading-tight z-10">
        ...
        <Image
          src="/svg/home1.png"
          alt="Хүүхэд математик сурч байгаа зураглал"
          width={468}
          height={400}
        ...
        <Image
          src="/svg/home2.png"
          alt="Интерактив сургалтын зураглал"
          width={330}
          height={244}
