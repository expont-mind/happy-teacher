        ...
        return (
            ...
            >
                ...
                {colors && setSelectedColor && (
                    <div
                        className={`absolute z-50 ${palettePosition === "bottom"
                            ? "bottom-4 left-1/2 -translate-x-1/2"
                            : "top-1/2 -translate-y-1/2 left-4"
                            }`}
                    >
                        <div
                            className={`flex gap-2 px-2 py-1 bg-white rounded-2xl border-2 border-slate-200 shadow-xl ${palettePosition === "bottom"
                        ...
                        >
                            {colors.map(({ color, label }) => (
                                <button
                                    ...
                                    className={`group relative flex flex-col items-center gap-0.5 p-1 rounded-xl transition-all duration-200 shrink-0 ${selectedColor === color
                                ...
                                >
                                    ...
                                    {label && (
                                        <span
                                            className={`text-base font-black min-w-8 text-center leading-none ${selectedColor === color ? "text-green-600" : "text-slate-700"
                                                }`}
                                        >
                                            {label}
                                        </span>
